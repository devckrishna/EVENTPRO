            ...
            <>
                <div className=" ml-16 login-card flex flex-col justify-evenly items-center   h-screen">
                    ...
                    <div className="flex justify-center gap-2 ">
                        ...
                        <span className="font-bold text-2xl text-white mr-16">Get into account</span>
                    </div>
                    <div className="  w-80 flex flex-col  h-80  mr-16 ">
                        <div className='text-gray-400 font-medium p-1 ' >Email</div>
                        ...
                        <div className='text-gray-400 font-medium p-1'>Password</div>
                        <input className=" p-1 rounded-md w-11/12 bg-center mx-auto font-semibold focus:outline-none" placeholder="******"></input>
                        <div className="flex justify-center">
                            <button  className=" bg-purple-700  text-white w-1/2 p-2 rounded-md mt-8 hover:opacity-90">Sign in</button>
                        </div>
                    </div>
                </div>
            </>
